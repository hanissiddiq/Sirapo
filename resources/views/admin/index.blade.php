                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-success mr-md-4 mr-3">
                                                ...
                                                <i class="flaticon-381-pin text-success" style="font-size:2rem; color:green;"></i>
                                                {{-- <i class="flaticon-381-pin w-100"></i> --}}
                                            </span>
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-secondary  mr-md-4 mr-3">
                                                ...
                                                <i class="flaticon-381-folder-15" style="font-size:2rem; color:#a02cfa;"></i>
                                            </span>
                                            <div class="media-body">
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-danger mr-md-4 mr-3">
                                                ...
                                                <i class="flaticon-381-calculator" style="font-size:2rem; color:#ff3282;"></i>
                                            </span>
                                            <div class="media-body">
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-warning  mr-md-4 mr-3">
                                                ...
                                                <i class="flaticon-381-calculator-1" style="font-size:2rem; color:#ffbc11;"></i>
                                            </span>
                                            <div class="media-body">
