                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./page-register.html">Monthly Report</a></li>
                            <li><a href="./page-login.html">Yearly Report</a></li>
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">About</a>
                                <ul aria-expanded="false">
                                    <li><a href="./page-error-400.html">Kritik & Saran</a></li>
                                    <li><a href="./page-error-403.html">Term & Condition</a></li>
                                    <li><a href="./page-error-404.html">Rekening Bank</a></li>
                    ...
                    <li>
                        ...
                        <a href="{{ route('logout') }}"
                            class=" ai-icon d-flex align-items-center mr-2 py-2 text-start text-danger"
